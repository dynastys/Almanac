...
import com.xy.xylibrary.signin.SignListReq;
...
public class TaskLogic {
    ...
    private int[] daysize = new int[]{110, 240, 360, 437, 535, 623, 723};
     ...
     * 任务列表
     */
    public void getAppTaskList(final Activity context, final RecyclerView listRecycler) {
...
//                            receive_btn.setBackground(context.getResources().getDrawable(R.drawable.withdraw_search_5));
    ...
    private void QuitDialog(final Activity context, final String appid, final String id,final TextView receive_btn) {
        try {
     ...
     * @param isDouble 是否翻倍
     */
    public void FinishTask(final Activity context, String appid, String id, boolean isDouble) {
