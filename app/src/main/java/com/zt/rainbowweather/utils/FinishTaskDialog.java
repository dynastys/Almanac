...
public class FinishTaskDialog extends Dialog implements NativeExpressAD.NativeExpressADListener {
    ...
    private Button finish_task_get_btn, finish_task_draw_btn;
    ...
    public FinishTaskDialog(Activity context, String title, int type) {
...
//                        dateBean.setTitle(aNative.title + "\n" + aNative.desc);
    ...
    private void BannerAd(LinearLayout adLin, FrameLayout bannerContainer, RelativeLayout GDTAd, ImageView adImageBanner) {//
        // 获得原生banner广告对象
        nativelogic = Ad.getAd().NativeAD(context, "98f8e423-02e0-49f5-989f-af46f5c59203", "02a78332-1634-41b4-ab14-e6904a824b3e", "67C53558D3E3485EA681EA21735A5003", new AdProtogenesisListener() {
            @Override
